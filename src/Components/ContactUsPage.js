...
//                 <div className="bg-green-100 body-font z-10 text-black p-8 rounded shadow-md mb-8">
...
//                             id="name"
//                             name="name"
//                             className="w-full p-2 border rounded-md bg-green-30 transition duration-300 focus:outline-none focus:border-blue-500 hover:border-blue-500"
//                         />
//                     </div>
//                     <div className="mb-4">
