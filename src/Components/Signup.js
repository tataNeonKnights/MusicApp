      ...
      <div className="w-full  rounded-lg shadow border-2 border-black border-t-black md:mt-0 sm:max-w-md xl:p-0 bg-opacity-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className='flex flex-col items-start justify-center'>
                      <label for="name" className="block mb-2 text-sm font-bold text-black ">Entert Your Name</label>
                  ...
                  <div className='flex flex-col items-start justify-center'>
                      <label for="password" className="block mb-2 text-sm font-bold text-black">Password</label>
                  ...
                  <div className='flex flex-col items-start justify-center'>
                      <label for="confirm password" className="block mb-2 text-sm font-bold text-black">Confirm Password</label>
